...
public class QueryStudent {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// display the students
			System.out.println("\n\nStudents who have last name of Zhang");
			displayStudents(theStudents);

			// query students: lastName='Zhang' OR firstName='Zheng'
			theStudents = session.createQuery(
			            "from Student s where" + " s.lastName='Zhang' OR s.firstName='Zheng'")
			            .getResultList();

			System.out.println("\n\nStudents who have last name of Zhang OR first name Zheng");
			displayStudents(theStudents);
